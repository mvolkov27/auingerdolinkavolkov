...
$\underset{v'_{i}}{\bullet}\!\!\!{\rrbb}\!\!\!\!\underset{u'_{i+1}}{\bullet}$ are inner strings of $\alpha$. It follows that $u_i\nequiv
v_i\nequiv u_{i+1} \bmod\ 2$ and therefore $u_i\equiv u_{i+1} \bmod\ 2$ for all $i$ whence $u_1\equiv u_s\bmod\ 2$. Consequently,
$\mathbf{s}$ is even if and only of $\mathbf u$ and $\mathbf v$ are both even or both odd while $\mathbf s$ is odd if and only if exactly
one of $\mathbf u$ and $\mathbf v$ is even. In particular, the set $\mathfrak{EA}_n$ of all even members of $\A_n$ forms a submonoid of
$\A_n$. Since each projection is even, $\mathfrak{EA}_n$ contains the Hermitian subsemigroup $\H(\A_n)$.
