...
$r^2\times r$-matrix $M$ shown in the left hand part
of Fig.~\ref{matrices}.
\begin{figure}[b]
$$M=\begin{pmatrix}
  1 & 1 & \cdots & 1 & 1\\
...
(shown in the right hand part of Fig.~\ref{matrices}) by replacing numbers
...
of the terms $Z_n\om(Z_n)\cdot Z_n'\om(Z_n')$ and $Z_n'\om(Z_n')$
...
$\H(\Sc)\subseteq\mathrm{L}^1_2(\mathcal{K})$, the set
...
identity $x^2yx=xyx^2$. Consequently, each group in $\var\H(\Sc)$ is
