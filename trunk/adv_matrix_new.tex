...
\title[Matrix Identities Involving Multiplication
and Transposition]{Matrix Identities Involving Multiplication\\
and Transposition}
...
is a standard convention which we adapt.} $x^2=0$. This identity is
...
identity $x=x\om(x)x$, an identity of the form \eqref{periodic}
holding in $\mathcal{S}$, and the identities \eqref{ziminR},
\eqref{idempotent law}, and \eqref{crucial law}. By
...
the monoids of triangular boolean matrices}, Algebra Universalis,
accepted.
