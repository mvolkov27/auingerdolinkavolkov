...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Version of September 17th, 2010 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
of $A$ corresponding to the eigenvalue $0$ coincides with either $K^n$ or $N(A)$.
...
see \cite[Section~5.10]{Meyer}. Then $R(A)$ is in fact the generalized eigenspace of
...
The definition of the symplectic transpose resembles
